...
public class IntOrderService
{
    ...
    public IntOrderService(String inWO) throws IOException,NoSuchAlgorithmException,KeyStoreException,KeyManagementException,SQLException,ClassNotFoundException,NumberFormatException
    {
        ...
        // set up endpoint
        HttpGet request = new HttpGet("https://order-service.integration.apps.int.dev.mer.cfdish.io:443/order/" +
    ...
    public static void main(String[] args) throws ClientProtocolException, IOException, NoSuchAlgorithmException,KeyStoreException,KeyManagementException, ClassNotFoundException, SQLException
    {
        ...
        // set up endpoint
        HttpGet request = new HttpGet("https://order-service.integration.apps.int.dev.mer.cfdish.io:443/order/1000005098393017?sessionId=1b89b701-067a-49a0-92d0-944b473403dc&agentId=carlos.loya");
