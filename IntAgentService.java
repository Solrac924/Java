...
public class IntAgentService
{
    ...
    public IntAgentService(String inAgent) throws IOException, NoSuchAlgorithmException,KeyStoreException,KeyManagementException
    {
        ...
        // send REST request
        HttpGet request = new HttpGet("https://agent-service.integration.apps.internal-green.dev.mer.cfdish.io:443/agent/" +
    ...
    public static void main(String[] args) throws IOException, NoSuchAlgorithmException,KeyStoreException,KeyManagementException,ClassNotFoundException,SQLException
    {
        ...
        // get REST response
        HttpGet request = new HttpGet("https://agent-service.integration.apps.internal-green.dev.mer.cfdish.io:443/agent//agent/DAVID.EASTRIDGE?sessionId=1b89b701-067a-49a0-92d0-944b473403dc");
        HttpResponse response = client.execute(request);
    ...
    static void showStatusCode() throws IOException, NoSuchAlgorithmException,KeyStoreException,KeyManagementException
    {
        ...
        // send REST request
        HttpGet request = new HttpGet("https://agent-service.integration.apps.internal-green.dev.mer.cfdish.io:443/agent/DAVID.EASTRIDGE?sessionId=1b89b701-067a-49a0-92d0-944b473403dc");
