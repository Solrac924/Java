...
public class testAccountService
{
    ...
    public testAccountService(String inAccount) throws IOException,NoSuchAlgorithmException,KeyStoreException,KeyManagementException,SQLException,ClassNotFoundException,NumberFormatException
    {
        ...
        // send REST request
        HttpGet request = new HttpGet("http://account-service.test.apps.internal-green.test.mer.cfdish.io:80/account/"
                + inAccount
    ...
    public static void main(String[] args) throws ClientProtocolException, IOException,NoSuchAlgorithmException,KeyStoreException,KeyManagementException
    {
        ...
        // send REST request
        HttpGet request = new HttpGet("http://account-service.test.apps.internal-green.test.mer.cfdish.io:80/account/8046909859387160?sessionId=1b89b701-067a-49a0-92d0-944b473403dc&agentId=carlos.loya");
        ...
        try
        {
            ...
            String sqlSUB = "select distinct acct.ACCOUNT_ID as \"accountId\"\n" +
                    ...
                    "     ,SUB_ACCOUNT_EMAIL email\n" +
                    "     ,SUB_ACCOUNT_TYPE_SPA spa\n" +
                    "where acct.ACCOUNT_ID = '8046909859387160'\n" +
                    "and acct.CUSTOMER_ID = cust.CUSTOMER_ID\n" +
                    "and cust.CUSTOMER_ID = custAddr.CUSTOMER_ID\n" +
                    "and custAddr.ADDRESS_ID = addr.ADDRESS_ID\n" +
                    "and acct.ACCOUNT_ID = sbb_base.SUB_ACCT_NO_SBB\n" +
