...
public class testNGUI
{
    ...
    public String BTechDMZ = "https://apps-test.dish.com/beacon-ui/products?agentId=carlos.loya&workOrderId=1000023084043017";
    ...
    public void loginDNS() throws Exception
    {
        ...
        // david.jobst
        // arshad.zaheer
        driver.findElement(By.xpath("//input[@id='password']")).sendKeys("Dish1234");
    ...
    public void openWO() throws Exception
    {
        ...
        try
        {
            driver.findElement(By.linkText("Activate Route") ).click();                            // Activate Route
            // <a class="button submit" id="queue-submit" href="#m=queue/a=activate/submit=1459873686-1626-8158">Yes</a>
            driver.findElement(By.id("queue-submit") ).click();                                    // Yes
        }
        catch (NoSuchElementException e)
        {
            System.out.println("Route is already activated");
        }
        ...
        catch (NoSuchElementException e)
        {
            ...
            driver.findElement(By.linkText("Start") ).click();                                     // click Start
            Thread.sleep(1000);
            driver.findElement(By.id("save_form") ).click();                                       // click OK
            //<input id="save_form" class="button submit" action-element="action-element" type="submit" name="submit" value="OK" action="#activity/start?aid=83410850&amp;submit=1457653504-3735-6743">
            Thread.sleep(1000);
            driver.findElement(By.linkText("Beacon") ).click();                                    // click Beacon Tech via linkText
            Thread.sleep(1000);
        }
    ...
    public void orderItems() throws Exception
    {
        ...
        Thread.sleep(4000);
        driver.findElement(By.xpath("//*[contains(text(),'Continue')]")).click();     	                     // Continue -> Payment Form
        Thread.sleep(2000);
        ...
        // loop until payment alert-title exists or until 30 seconds
    ...
    public void validateDOMO()  throws SQLException,IOException,InterruptedException
    {
        ...
        String acctNumber = driver.findElement(By.className("headerUserInfo-accountId") ).getText();
        System.out.println("\nacctNumber: " + acctNumber);

        // from acct# get latest WO#
        String custOrdID = DOMO.acctNumToCustOrdID(acctNumber);
        System.out.println("custOrdID: " + custOrdID);

        String products = DOMO.getProducts(custOrdID);
