...
public class IntGemfireAPI
{
    public static void main(String[] args) throws ClientProtocolException, IOException, NoSuchAlgorithmException,KeyStoreException,KeyManagementException
    {
        ...
        HttpGet request = new HttpGet("http://dev-mec-gemfire-review.a.dish.com:8080/gemfire-api/v1/queries/adhoc?q=select%20*%20from%20%2FOffering");
