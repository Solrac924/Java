...
public class testPricerService
{
    String respTotal = "";
    ...
    public testPricerService(String inRequest) throws IOException, NoSuchAlgorithmException,KeyStoreException,KeyManagementException
    {
        ...
        String endPoint = "https://pricer-service.test.apps.internal-green.test.mer.cfdish.io:443/price-quote?sessionId=1b89b701-067a-49a0-92d0-944b473403dc&agentId=carlos.loya";
        ...
        while (st.hasMoreTokens() )
        {
            ...
            if (currToken.contentEquals("amount") )
            {
                ...
                int begin = respAmount.indexOf(':') + 1;
            ...
            if (currToken.contains("amountDueNow") )
            {
                ...
                int begin = respAmtDueNow.indexOf(':') + 1;
    ...
    public static void main(String[] args) throws IOException, NoSuchAlgorithmException,KeyStoreException,KeyManagementException
        {
            ...
            // set up endpoint
            HttpPost post = new HttpPost("https://pricer-service.test.apps.internal-green.test.mer.cfdish.io:443/price-quote?sessionId=1b89b701-067a-49a0-92d0-944b473403dc&agentId=carlos.loya");
