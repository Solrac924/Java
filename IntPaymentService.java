...
public class IntPaymentService
{
    public static void main(String[] args) throws IOException, NoSuchAlgorithmException,KeyStoreException,KeyManagementException,ClassNotFoundException,SQLException
    {
        ...
        // set up endpoint
        HttpGet request = new HttpGet("https://payment-service.integration.apps.int.dev.mer.cfdish.io:443/payment/lastsuccessfulpayment/8046909805388908?sessionId=1b89b701-067a-49a0-92d0-944b473403dc&agentId=carlos.loya");
    ...
    static void showStatusCode() throws IOException, NoSuchAlgorithmException,KeyStoreException,KeyManagementException
    {
        ...
        // send REST request
        HttpGet request = new HttpGet("https://payment-service.integration.apps.int.dev.mer.cfdish.io:443/payment/lastsuccessfulpayment/8046909806362654?sessionId=1b89b701-067a-49a0-92d0-944b473403dc&agentId=carlos.loya");
    ...
    static int getStatusCode() throws ClientProtocolException, IOException, NoSuchAlgorithmException,KeyStoreException,KeyManagementException
    {
        ...
        // send REST request
        String endPoint = "https://payment-service.integration.apps.int.dev.mer.cfdish.io:443/payment/card?sessionId=1b89b701-067a-49a0-92d0-944b473403dc&agentId=carlos.loya";
        HttpPost post = new HttpPost(endPoint);

        // set up JSON request
        StringEntity request = new StringEntity(
                        "{\n" +
                        "   \"accountId\": \"8046909806362654\",\n" +
                        "   \"paymentAmount\": 100,\n" +
                        "   \"paymentNote\": \"TEST\",\n" +
                        "   \"paymentReason\": \"TEST\",\n" +
                        "   \"paymentSource\": \"WEB\",\n" +
    ...
    static int postCCPymt(String inCard, String inMonth,String inYear, Integer inAmount) throws ClientProtocolException, IOException, NoSuchAlgorithmException,KeyStoreException,KeyManagementException
    {
        ...
        // send REST request
        String endPoint = "https://payment-service.integration.apps.int.dev.mer.cfdish.io:443/payment/card?sessionId=1b89b701-067a-49a0-92d0-944b473403dc&agentId=JASON.BODY";
        HttpPost post = new HttpPost(endPoint);
    ...
    static int postEFTPymt(String inAcct, String inChkAcct, String inRouting) throws ClientProtocolException, IOException, NoSuchAlgorithmException,KeyStoreException,KeyManagementException
    {
        ...
        // send REST request
        String endPoint = "https://payment-service.integration.apps.int.dev.mer.cfdish.io:443/payment/eft?sessionId=1b89b701-067a-49a0-92d0-944b473403dc&agentId=JASON%20BODY";
        HttpPost post = new HttpPost(endPoint);
    ...
    static boolean lookupLastSuccessful(String inAcct) throws ClientProtocolException, IOException, NoSuchAlgorithmException,KeyStoreException,KeyManagementException,ClassNotFoundException,SQLException
    {
        ...
        // send REST request
        HttpGet request = new HttpGet("https://payment-service.integration.apps.int.dev.mer.cfdish.io:443/payment/lastsuccessfulpayment/" +
