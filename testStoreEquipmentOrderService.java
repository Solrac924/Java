...
public class testStoreEquipmentOrderService
{
    public static void main(String[] args) throws IOException, NoSuchAlgorithmException,KeyStoreException,KeyManagementException
    {
        ...
        // set up endpoint
        HttpPost post = new HttpPost("https://store-equipment-order-service.test.apps.internal-green.test.mer.cfdish.io:443/store-equipment-order?sessionId=1b89b701-067a-49a0-92d0-944b473403dc&agentId=test.test");
