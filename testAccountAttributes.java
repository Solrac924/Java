...
public class testAccountAttributes
{
    String dbPartner = "";
    String dbAcctType = "";
    ...
    public testAccountAttributes(String inAccount, String inTagCode) throws IOException, NoSuchAlgorithmException,KeyStoreException,KeyManagementException
    {
        ...
        String endPoint = "https://account-attributes.test.apps.internal-green.test.mer.cfdish.io/account/"
                + inAccount
    ...
    public static void main(String[] args) throws IOException, NoSuchAlgorithmException,KeyStoreException,KeyManagementException
    {
        ...
        HttpPost post = new HttpPost("https://account-attributes.test.apps.internal-green.test.mer.cfdish.io/account/8046110001234567/attributes?sessionId=1b89b701-067a-49a0-92d0-944b473403dc&agentId=test.test");
